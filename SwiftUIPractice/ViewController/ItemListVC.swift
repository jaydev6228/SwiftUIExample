                ...
                VStack(alignment: .leading, spacing: 10) {
                    ...
                    List(items) { item in
                        ItemRow(item: item)
                            .gesture(TapGesture()
                                    .onEnded({ _ in
                                print("start selected",item.id)
                                selectedFruit = item.id
                            ...
                            .listRowBackground(selectedFruit == item.id ? AppConstant.AppColor.kGreenLight : Color.clear)
                    }
                    .listStyle(.plain)
...
struct ItemListVC_Previews: PreviewProvider {
